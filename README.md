...
```
cd existing_repo
git remote add origin https://gitlab.com/biker1/front-end.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/biker1/front-end/-/settings/integrations)
